...
\subsection{Diagrama de clases general}

\begin{center}
	\includegraphics[scale=0.9,angle=90]{Imagenes/MVC}
	\figcaption{Diagrama de clases MVC}
\end{center}

\clearpage

\subsection{Diagrama de clases sólo modelo}

\begin{center}
	\includegraphics[scale=0.8,angle=90]{Imagenes/Clases}
