...
Primario: Usuario.
\subsubsection{Breve descripción}
Un usuario registrado puede consultar los amigos accediento a la lista de los mismos. Haciendo click en el nombre de su amigo, accederá al perfil del mismo.
\subsubsection{Flujo básico}
\begin{enumerate}
	\item
\end{enumerate}
