...
\hline 
\end{tabular} 
\tabcaption{Coste recursos humanos}
\end{center}
...
\end{tabular}
\tabcaption{Desglose coste recursos materiales}\label{tab:coste_material}
\end{center}


\begin{center}
\includegraphics[scale=0.4]{imagenes/git_precios.png}
\figcaption{Licencia Git para organización}\label{fig:git_precios}
\end{center}
...
\figcaption{Desglose de costes}\label{fig:cotes_desglose}
\end{center}
